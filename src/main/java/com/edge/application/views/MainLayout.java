...
import com.edge.application.views.about.AboutView;
import com.edge.application.views.edge.EdgeView;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Edge", EdgeView.class, "la la-file"));
