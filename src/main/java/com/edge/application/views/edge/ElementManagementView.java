...
@PermitAll
@PageTitle("Element Management")
@Route(value = "elementmanagement", layout = MainLayout.class)
public class ElementManagementView extends VerticalLayout {
	...
	public void init() {
		...
		layout_left.add(createLayout("Element", VaadinIcon.CLIPBOARD_USER, elementList.class));
		
		layout_left.add(createLayout("Tag",VaadinIcon.USER_CLOCK, TagList.class));
		layout_left.getStyle().set("align-items" ,"end");
		
		//RIGHT-VERTICAL-LAYOUT
		layout_right.add(createLayout("Source Element Tag Mapping", VaadinIcon.ACADEMY_CAP, ElementTagMappingList.class));
		//layout_right.add(createLayout("Source Element Mapping", VaadinIcon.ACADEMY_CAP, SourceElementMappingList.class));
